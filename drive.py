    ...
    if data:
        ...
        if args.image_folder != '':
            ...
            if(1):
                ...
                str1=image_filename+'.jpg,,,'+str(steering_angle)+\
                ','+str(throttle)+\
                ',' +\
                ','+str(speed)+\
                ',\n'
                fp.write(str1)
            print('%.3f'%steering_angle,'%.3f'%float(throttle), '%.3f'%float(speed), str(fo))
            fo+=1
    else:
...
if __name__ == '__main__':
    fp=open("out.csv","w")
    fo=0
    fp.write("center, left, right, steering, throttle, break, speed\n")
